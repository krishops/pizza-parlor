...
$(document).ready(function () {
  $("form#pizza-parlor").submit(function (event) {
    ...
    let price = newParlor.pizzaPrice(newPizza["id"], inputtedSize, inputtedToppingOne, inputtedToppingTwo, inputtedToppingThree, inputtedToppingFour);
    $("#pizza-price").html(price)
  });
});
